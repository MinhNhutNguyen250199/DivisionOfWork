...
namespace DivisionOfWorkWebAPI.Migrations
{
    ...
    [Migration("20211207072805_IdentityCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DivisionOfWorkWebAPI.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DivisionOfWorkWebAPI.Entities.Task", b =>
                {
            ...
            modelBuilder.Entity("DivisionOfWorkWebAPI.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DivisionOfWorkWebAPI.Entities.Task", b =>
                {
                    b.HasOne("DivisionOfWorkWebAPI.Entities.User", "Assigee")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("DivisionOfWorkWebAPI.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("DivisionOfWorkWebAPI.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
